...
limit 5;
--compare the average purchase amounts between standard(3-8 days) and express(1-3 days) shipping
...
--what are the top 3 most purchaed products within each category?
with item_counts as (
...
from item_counts
where item_rank<=3;
--are customers who are repeat buyera also likely to subscribe?
select subscription_status,
